...
class _EntretienState extends State<Entretien> {
  ...
  final List<String> options = ['Coûts d\'Entretien Mensuels', 'Coûts total des Entretien par Type'];
          ...
          Expanded( // Assurez-vous que le DropdownButton est dans un Expanded
            child: DropdownButton<String>(
              ...
              onChanged: (String? newValue) {
                ...
                if (newValue == 'Coûts total des Entretien par Type') {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => MaintenanceCostPieChart()),
                  );
                }
                    if (newValue == 'Coûts d\'Entretien Mensuels') {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => MonthlyMaintenanceCostChart()),
                  );
                }
              },
            ),
